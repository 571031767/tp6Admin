...
class Index extends Common
{
    ...
    {
        $usercount = User::where(1)->count();
        View::assign("usercount",$usercount);

        $pvcount = Content::where(1)->sum("rel_hits");
        View::assign("pvcount",$pvcount);

        $new_comment = Comment::whereDay('create_time')->select()->count();
        View::assign("new_comment",$new_comment);
        return \view();
    }
